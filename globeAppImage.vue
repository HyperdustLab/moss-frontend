<template>
  <div v-if="images">
    <template v-if="images.length === 1">
      <img v-if="image" :src="showImage" @mouseenter="appMouseenter" @mouseleave="appMouseleave" style="width: 100%; height: 600px" class="image" />

      <img v-else :src="images[0]" style="width: 100%; height: 600px" class="image" />
    </template>

    <el-carousel v-else height="300px">
      <el-carousel-item v-for="(item, index) in images" :key="index">
        <img :src="item" style="width: 100%; height: 600px" class="image" />
      </el-carousel-item>
    </el-carousel>
  </div>
</template>
